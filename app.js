document.addEventListener('DOMContentLoaded', () => {
    ...
    $("#gameButtonContainer").on("click", ".widthButton", function (event) {
        ...
        let widthDif = width - chosenWidth;
        let newWidthDif = widthDif;
    ...
    function control(e) {
        ...
        if (e.key === "d" || e.key === "D") { // Moves puyos right when d key is pressed
            moveRight();
        } else if (e.key === "w" || e.key === "W") { // Moves puyos instantly to the bottom when w key is pressed
            hardDrop(); }
